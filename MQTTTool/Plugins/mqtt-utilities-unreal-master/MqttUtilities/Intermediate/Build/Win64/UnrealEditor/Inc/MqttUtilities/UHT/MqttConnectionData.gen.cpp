...
template<> MQTTUTILITIES_API UScriptStruct* StaticStruct<FMqttConnectionData>()
{
	...
	struct Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_1827426368(TEXT("/Script/MqttUtilities"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttConnectionData_h_Statics::ScriptStructInfo),
		nullptr, 0);
