...
template<> MQTTUTILITIES_API UScriptStruct* StaticStruct<FMqttClientConfig>()
{
	...
	struct Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_1048474184(TEXT("/Script/MqttUtilities"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID__projects_mqtt_tests_ue_MyProject___Copy_Plugins_mqtt_utilities_unreal_master_MqttUtilities_Source_MqttUtilities_Public_Entities_MqttClientConfig_h_Statics::ScriptStructInfo),
		nullptr, 0);
